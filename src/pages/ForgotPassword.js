    ...
    return (
        <div className="flex justify-center items-center h-screen bg-black">
            <div className="w-full max-w-sm p-4 rounded-lg shadow sm:p-6 md:p-8">
                <form className="space-y-12" onSubmit={handleChangepassword}>
                    ...
                    <div>
                        <input type="password" name="password" id="password" placeholder="New Password" className="my-12 bg-zinc-800   text-white text-sm rounded-3xl block w-full p-2.5" style={{"boxShadow": "inset 0px 3px 3px rgba(255, 253, 253, 0.25), 3px 3px 3px rgba(74, 73, 73, 0.47)"}} required />
                    </div>
                    <div className="bg-gradient-to-br rounded-3xl from-green-500 via-black to-green-900 border-2 border-green-500 opacity-100">
  <button type="submit" className="w-full text-white rounded-3xl  font-medium text-2xl px-5 py-2.5 text-center " style={{"background": "linear-gradient(180deg, rgba(0, 255, 37, 0.5) 0%, #000000 100%, rgba(54, 165, 70, 0.5) 100%) 0% 0% no-repeat padding-box"}}>Change Password</button>
</div>
